title: markdown基本语法 #文章页面上的显示名称，可以任意修改，不会出现在URL中
date: 2016-04-22 16:47:01
categories: 参考资料  #文章分类目录，可以为空，注意:后面有个空格
tags: [markdown]  #文章标签，可空，多标签请用格式[tag1,tag2,tag3]，注意:后面有个空格
---
## 主要内容 ##
> #### Markdown是_什么_？ ####
> #### _谁_发明了这么个东西？ ####
